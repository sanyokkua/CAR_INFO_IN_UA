package ua.kostenko.carinfo.producer.producing.data.services;
...
import ua.kostenko.carinfo.producer.producing.data.repositories.RegistrationInformationCrudRepository;
