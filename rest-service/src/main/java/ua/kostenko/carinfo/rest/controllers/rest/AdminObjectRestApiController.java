...
public class AdminObjectRestApiController
        extends DefaultApiController<AdministrativeObject, String, AdministrativeObjectResource> {

    @Autowired
    protected AdminObjectRestApiController(@Nonnull @NonNull SearchService<AdministrativeObject, String> searchService,
    ...
    @Override
    public PagedResources<AdministrativeObjectResource> find(PagedResourcesAssembler<AdministrativeObject> assembler,
            Pageable pageable, @PathVariable(required = false) String indexField) {
        return getFindResult(assembler, pageable, indexField);
    }

    @GetMapping("findByParams")
    @Override
    public PagedResources<AdministrativeObjectResource> findByParams(
            PagedResourcesAssembler<AdministrativeObject> assembler, Pageable pageable, AdministrativeObject params) {
