...
public class AdministrativeObjectAssembler
        extends ResourceAssemblerSupport<AdministrativeObject, AdministrativeObjectResource> {
    ...
    @Override
    public AdministrativeObjectResource toResource(final AdministrativeObject entity) {
        final AdministrativeObjectResource resource = super.createResourceWithId(entity.getId(), entity);
