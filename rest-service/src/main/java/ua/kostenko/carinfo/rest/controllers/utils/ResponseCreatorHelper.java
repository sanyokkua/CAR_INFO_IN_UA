...
public class ResponseCreatorHelper {
    ...
    private Auto getAuto(RegistrationInformationEntity registrationInformation) {
        return new Auto(registrationInformation.getCarBrand(), registrationInformation.getCarModel(), registrationInformation.getCarMakeYear(), registrationInformation
                .getCarColor(),
    ...
    private ServiceCenter getServiceCenter(RegistrationInformationEntity registrationInformation, ServiceCenterEntity serviceCenterEntity) {
        return new ServiceCenter(serviceCenterEntity.getDepId(), serviceCenterEntity.getAddress(), serviceCenterEntity.getEmail(), registrationInformation.getDepartmentName());
    }
}
